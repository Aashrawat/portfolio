...
describe("CommentsHandler", () => {
	...
	describe("createComment", () => {
		...
		it("returns error for invalid session token", async () => {
			vi.mocked(requireAuth).mockRejectedValue(new Error("Invalid or expired session token"));
	...
	describe("getPostComments", () => {
		...
		it("ignores invalid token for public access", async () => {
			vi.mocked(resolveAuthContext).mockRejectedValue(new Error("Invalid token"));
